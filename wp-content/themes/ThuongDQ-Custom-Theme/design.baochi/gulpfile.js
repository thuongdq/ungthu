...
var config = {
    ...
    jsConcatFiles: [
        ...
        'app/bower_components/jquery.bxslider/jquery.bxslider.js',
        'app/js/end.js',
        '!app/js/app.bundle.js'
    ],
    jsMinFiles: [
...
gulp.task('watch', function() {
    ...
    gulp.watch(config.jsMinFiles, ['min-scripts']);
...
// Default Tasks
// ///////////////////////////////////////////////
gulp.task('default', ['compile-es6', 'scripts', 'min-scripts', 'compass', 'min-styles', 'fonts', 'html', 'browser-sync', 'watch']);