            ...
            <section>
                <div class="title-category">
                    <ul class="nav nav-pills">
                        <li>
                            <a href="<?php echo get_category_link($cac_benh_ung_thu); ?>" title="<?php echo $cac_benh_ung_thu->name; ?>" >
                                <?php echo $cac_benh_ung_thu->name; ?>
                            </a>
                        </li>
                        <li>
                ...
                <div class="category-child">
                      <?php wp_nav_menu(array("menu" => client_get_options('home-box-2-sub-category-1'), 'container' => '', 'container_class' => '', 'menu_class' => 'nav nav-pills pull-right more')); ?>
                </div>
            </section>
