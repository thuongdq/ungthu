...
$list_child_cac_benh_ung_thu = get_term_children( $cac_benh_ung_thu->term_id, "category");
$list_child_benh_ly_lien_quan = get_term_children( $benh_ly_lien_quan->term_id, "category");
?>
<?php get_header(); ?>
    ...
    <main>
        <div class="container">
            <?php
            if(in_array($current_category->term_id, $list_child_cac_benh_ung_thu)){
                echo '
                    <section>
                        <div class="title-category">
                            <ul class="nav nav-pills">
                                <li>
                                    <a href="'.get_category_link($cac_benh_ung_thu).'" title="'.$cac_benh_ung_thu->name.'" >
                                        '.$cac_benh_ung_thu->name.'
                                    </a>
                                </li>
                                <li>
                                    <a href="'.get_category_link($current_category).'" title="'.$current_category->name.'" class="current-category">
                ...
                ';
            }else if(in_array($current_category->term_id, $list_child_benh_ly_lien_quan)){
                echo '
                    <section>
                        <div class="title-category">
                            <ul class="nav nav-pills">
                                <li>
                                    <a href="'.get_category_link($benh_ly_lien_quan).'" title="'.$benh_ly_lien_quan->name.'" >
                                        '.$benh_ly_lien_quan->name.'
                                    </a>
                                </li>
                                <li>
                                    <a href="'.get_category_link($current_category).'" title="'.$current_category->name.'" class="current-category">
                ...
                echo '
                    <section>
                        <div class="title-category">
                            <ul class="nav nav-pills">
                                <li>
                                    <a href="#" title="#">Tin tức ung thư</a>
                                </li>
                                <li>
                                    <a href="#" title="#">Tin ung thư trong nước</a>
                                </li>
                                <li>
                                    <a class="current-category" href="#">Tin ung thư quốc tế</a>
                                </li>
                                <li>
                                    <a href="#" title="#">Nghin cứu khoa học ung thư</a>
                                </li>
                                <li>
                                    <a href="#" title="#">Văn bản chính sách</a>
                                </li>
                            </ul>
                        </div>
                    </section>
